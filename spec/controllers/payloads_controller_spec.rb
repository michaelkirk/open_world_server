...
describe PayloadsController do
  ...
  describe "GET index" do
    it "assigns all payloads as @payloads" do
      ...
      get :index, { :point_id => 2 }, valid_session
      assigns(:payloads).should eq([payload])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested payload as @payload" do
      payload = Payload.create! valid_attributes
      get :show, {:point_id => 2, :id => payload.to_param}, valid_session
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Payload" do
        expect {
          post :create, {:point_id => 2, :payload => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved payload as @payload" do
        ...
        post :create, {:point_id => 2, :payload => { "data" => nil }}, valid_session
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested payload" do
        ...
        put :update, {"point_id" => 2, "id" => payload.to_param, "payload" => valid_attributes}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the payload as @payload" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Payload.any_instance.stub(:save).and_return(false)
        put :update, {:point_id => 2, :id => payload.to_param, :payload => { "data" => nil }}, valid_session
        assigns(:payload).should eq(payload)
      end
    end
  end
  ...
  describe "DELETE destroy" do
    it "destroys the requested payload" do
      payload = Payload.create! valid_attributes
      expect {
        delete :destroy, {:point_id => 2, :id => payload.to_param}, valid_session
      }.to change(Payload, :count).by(-1)
    end
